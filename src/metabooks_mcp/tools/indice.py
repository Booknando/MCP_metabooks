...
def register(mcp: FastMCP) -> None:
    ...
    async def metabooks_index_search(
        ...
        field: Annotated[
            ...
            Field(description="Índice a consultar: author, publisher, title, keyword, "
                              "set, collection ou identifier"),
        ],
        term: Annotated[
            str,
            Field(description="Termo de busca (retorna até 100 entradas, sem paginação)"),
        ],
    ) -> dict:
